...
var e2=e.replace(e,'<img src="http://img.movieright.us/backdrop.php?img='+a+'" width="560" height="auto" />');
document.getElementById("backdrop").innerHTML=e2;
var s=document.getElementById("pst").innerHTML;
var s2=s.replace(s,'<img src="http://img.movieright.us/poster.php?img='+a+'" width="200" height="300" />');
